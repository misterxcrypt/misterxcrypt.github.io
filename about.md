...
to understand 90% scammer tactics.
- **Automation:** Deployed a Python-based cybersecurity product (Selenium, MongoDB, Celery), streamlining threat data
...
scammer profiles.
- **Cyber Threat Analysis:** Monitored Telegram and the Dark Web, generating over 20 threat reports on cybercrime activity.
- **Cross-Team Collaboration:** Partnered with design and development teams to enhance product features and fix bugs.
- **Reporting:** Maintained a database of cyber threat data, generating over 80 reports and threat briefings for stakeholders.
...
- This project is built with Python and Flask for the backend, and HTML, CSS, and JavaScript on the front-end.
